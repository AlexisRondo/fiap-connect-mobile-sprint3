            ...
            >
              ...
              <TouchableOpacity
                style={[
                  styles.cardButton,
                  {
                    backgroundColor: hasNewInvite
                      ? colors.DestaqueFIAP
                      : colors.TextoSecundario,
                  },
                ]}
                onPress={() =>
                  handleNavigation(hasNewInvite ? "invites" : "profilepage")
                }
              >
                <Text style={styles.buttonText}>
                  {hasNewInvite ? "Ver Convite" : "Ver Perfil"}
                </Text>
              </TouchableOpacity>
            </View>
          </View>
        ...
        <View style={styles.section}>
          ...
          {isGroupFormed ? (
            ...
            >
              ...
              >
                Parabens! Seu Grupo esta Formado!
              </Text>
              <TouchableOpacity
                style={[
